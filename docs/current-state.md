...
O Scanora `0.2.7` é um scanner Android local-first. O fluxo principal abre o ML Kit Document Scanner; CameraX e o seletor de imagens permanecem como alternativas editáveis. Não há conta, backend, sincronização ou envio automático de documentos.
...
- exportação ainda usa buffers grandes e será reformada na `0.2.8`;
