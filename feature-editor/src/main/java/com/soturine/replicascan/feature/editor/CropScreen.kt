        ...
        if (page == null) {
            ...
            Column(
                ...
                Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    OutlinedButton(
                        onClick = { localQuad = com.soturine.replicascan.core.common.model.DocumentDetectionResult.FULL_PAGE_QUAD },
                        enabled = !state.isProcessing,
            ...
            item {
                Card(
                    ...
                    Row(
                        ...
                        ReplicaScanMascot(ReplicaScanMascotState.Working, size = 86.dp)
                    }
                }
            }
            item {
    ...
    Box(
        ...
        Surface(
            ...
            Column(
                ...
                ReplicaScanMascot(state = ReplicaScanMascotState.Processing, size = 72.dp)
                Text(
                    text = text,
                    style = MaterialTheme.typography.bodyMedium,
                )
